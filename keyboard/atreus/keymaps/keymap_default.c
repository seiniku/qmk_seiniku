...
[_QW] = { /* Colemak */
  ...
  {KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC,  KC_LCTL, KC_FN0,  MO(_RS), KC_MINS, KC_QUOT, KC_ENT  }
...
[_LW] = { /* [> LOWER <] */
  ...
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  DF(_QW), KC_TRNS, KC_TRNS, RESET}
}};
