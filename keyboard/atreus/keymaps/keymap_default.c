...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  {KC_ESC,      KC_TAB, KC_LGUI, KC_LSFT, KC_BSPC, CTL_T(KC_ESC), LT(_RS, KC_SPC), MO(_LW), KC_MINS, KC_QUOT, KC_NO}
...
[_RS] = {
  ...
  {KC_TRNS, KC_INS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DOT, KC_0, KC_EQL}
},
...
[_LW] = { 
  ...
  {KC_FN0, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET}
}};

const uint16_t PROGMEM fn_actions[] = {
  [0] = ACTION_MODS_KEY(MOD_LCTL | MOD_LALT, KC_DEL)
};
