...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox(KC_ESCAPE,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_TRANSPARENT,
                       ...
                       KC_DOWN,KC_4,KC_5,KC_6,KC_TRANSPARENT,KC_PLUS,
                       KC_TRANSPARENT,KC_AMPR,KC_1,KC_2,KC_3,KC_BSLASH,KC_BSLS,
                       KC_NO,KC_DOT,KC_0,KC_EQUAL,KC_EQL,
