...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,
                       KC_DELETE,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(2),
                       LCTL_T(KC_ESCAPE),KC_A,KC_S,KC_D,KC_F,KC_G,
                       KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_HYPR,
                       LT(2,KC_GRAVE),KC_LBRACKET,KC_TAB,KC_LEFT,KC_RIGHT,
                       ...
                       KC_H,KC_J,KC_K,KC_L,LT(3,KC_SCOLON),LGUI_T(KC_QUOTE),
                       KC_MEH,KC_N,KC_M,KC_COMMA,KC_DOT,KC_KP_SLASH,KC_RSHIFT,
                       KC_UP,KC_DOWN,KC_QUOTE,KC_RBRACKET,MO(2),

                       KC_LALT,LCTL_T(KC_ESCAPE),KC_PGUP,
  ...
  [1] = LAYOUT_ergodox(KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
                      KC_TRANSPARENT,KC_Q,KC_W,KC_F,KC_P,KC_G,KC_TRANSPARENT,
                      KC_TRANSPARENT,KC_A,KC_R,KC_S,KC_T,KC_D,
                      KC_TRANSPARENT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_TRANSPARENT,
                      KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,

                      KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
                      KC_TRANSPARENT,LCTL_T(KC_ESCAPE),KC_TRANSPARENT,

                      KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
                      KC_TRANSPARENT,KC_J,KC_L,KC_U,KC_Y,KC_SCOLON,KC_TRANSPARENT,
                      KC_H,KC_N,KC_E,KC_I,KC_O,KC_TRANSPARENT,
                      KC_TRANSPARENT,KC_K,KC_M,KC_COMMA,KC_DOT,KC_KP_SLASH,KC_TRANSPARENT,
                      KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,

                      KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
                      KC_TRANSPARENT,RALT_T(KC_ENTER),KC_TRANSPARENT),

  [2] = LAYOUT_ergodox(KC_ESCAPE,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_TRANSPARENT,
  ...
  [3] = LAYOUT_ergodox(KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
